...
typedef struct EngineEvent { uint32_t kind; uint64_t frame_index; EarthRenderState state; } EngineEvent;
typedef void (*RustEngineEventCallback)(void*, EngineEvent);
...
void rust_engine_set_event_callback(RustEngine*, RustEngineEventCallback, void*);
void rust_engine_clear_event_callback(RustEngine*);
